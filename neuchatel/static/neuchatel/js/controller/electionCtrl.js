...
neuchatelApp.controller("electionCtrl", function ($scope, $routeParams, $location, Backend, $rootScope, $window) {
    ...
    function encryptContd(is_manipulated) {
        ...
        if (is_manipulated) {
            ...
            console.log(attack);
            $rootScope.selected_code = $scope.options[attack];
            console.log($rootScope.selected_code);
            $rootScope.choice = $scope.options[$rootScope.selected_code].option;
            console.log();
            $rootScope.return_code = $scope.options[$rootScope.selected_code].option_return_code;
