"""
Django settings for helios_usabilitystudy project.
...
SECRET_KEY = 'sdy+8nc@g1693x=l*kao_gzbnz-4&ho(7af_hl@q1l37vw)sl*'
...
ROOT_URLCONF = 'helios_usabilitystudy.urls'
...
WSGI_APPLICATION = 'helios_usabilitystudy.wsgi.application'
